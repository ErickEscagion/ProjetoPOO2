...
public class EventDTO {
    ...
    public EventDTO(@NotBlank(message = "The name of the event is mandatory!") String name,
            ...
            @NotBlank(message = "Mandatory start dateTime!") LocalDateTime startDateTime,
            @NotBlank(message = "Mandatory start dateTime!") LocalDateTime endDateTime,
