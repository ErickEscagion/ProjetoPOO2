...
INSERT INTO TB_EVENT(name, description, email_Contact,start_Date,end_Date,start_Time,end_Time,amount_free_tickets,amount_paid_tickets,free_tickets_selled,paid_tickets_selled,price_ticket,admin_user_id) VALUES ('Evento da Laura','Descricao do Evento da Laura', 'Laura@contato.com', '2021-03-25', '2021-03-25', '16:00:00', '22:30:10', 5, 255, 2, 2, 90, 2);
...
INSERT INTO TB_TICKET(type, date, price, attend_user_id, event_id) VALUES (0, CURRENT_TIMESTAMP, 0, 5, 3);
INSERT INTO TB_TICKET(type, date, price, attend_user_id, event_id) VALUES (1, CURRENT_TIMESTAMP, 90, 6, 3);
INSERT INTO TB_TICKET(type, date, price, attend_user_id, event_id) VALUES (1, CURRENT_TIMESTAMP, 90, 7, 3);
